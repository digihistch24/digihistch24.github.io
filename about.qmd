...
All online content (documents, web pages and their parts) on the website of the University of Basel are protected by copyright and may only be copied and printed for private, scientific and non-commercial use.  
Any copying, reproduction, retransmission or other use of the information on this website for commercial purposes is prohibited. This applies in particular to the logo of the University of Basel. Any requests for permission should be addressed in writing to the University of Basel, Web Services: [webservices@unibas.ch](mailto:webservices@unibas.ch).
